import Image1977 from '@assets/image/history/1977.webp';
import Image1998 from '@assets/image/history/1998.webp';
  ...
  intro: (
    <>
      ...
      <p>
        ...
        adanya campur tangan pihak ketiga sehingga memepengaruhi beberapa anggota organisasi ini.
        Timbul rasa curiga mencurigai dalam masalah sekte/kelompok, yang mengakibatkan perpecahan
        dan akhirnya organisasi ini bubar dengan sendirinya. Dari pengalaman ini, terlihat suatu
        kelemahan dalam diri kita sebagai seorang generasi muda, yaitu kebodohan yang seharusnya
        tidak perlu timbul apabila kita memahami bahwa timbulnya suatu perbedaan pendapat merupakan
        suatu hal wajar dalam setiap diri manusia hal ini bukan merupakan suatu sikap negatif, harus
        kita olah dalam hidup ini. Tinggal bagaiamana kita mengendalikannya sehingga menghasilkan
        sesuatu yang berharga bagi diri kita sendiri maupun mahkluk hidup lainnya.
      </p>
      <p>
        ...
        diberi kepercayaan untuk mengembangkan potensi mereka dalam sautu organsiasi Buddhis? Apa
        yang dapat kita berikan atau perbuat demi perkembangan Buddha Dhamma untuk generasi muda
        Buddhis?
      </p>
      <p>
        Sebuah cita-cita yang penting bagi kita semua yaitu untuk memiliki suatu organisasi sebagai
        wadah pemersatu dan pengalang persaudaraan kaum terpelajar serta kawula muda Buddhis
        sehingga muncul kekuatan baru untuk tetap konsisten menjaga dan mengembangkan Buddha Dhamma
      ...
      <p>
        ...
        Dhamma yang baik, serta kemampuan manajerial dan bakat kepemimpinan yang kuat, sehingga
        fungsi-fungsi manajemen dapat dilaksanakan dan apabila timbul suatu masalah, maka masalah
